...
VCL::Module::OS::Windows::Version_7.pm - VCL module to support Windows 7.x operating systems
...
=cut
	...
	notify($ERRORS{'OK'}, 0, "beginning Windows version 7 image pre-capture tasks");

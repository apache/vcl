...
VCL::Module::OS::Windows::Version_10::10.pm - VCL module to support deployment of Windows 10.x operating systems

=head1 DESCRIPTION

 This module provides support for the deployment of Windows 10.x operating systems.
